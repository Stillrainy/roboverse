...
class DrawerCloseOpenTransfer:
    ...
    def reset(self):
        ...
        offset_coeff = (-1) ** (1 - env_attr(self.env, 'left_opening'))
    ...
    def get_action(self):
        ...
        top_drawer_pos = env_attr(self.env, 'get_drawer_pos')("drawer_top")
        ...
        neutral_action = [0.0]
        if (not env_attr(self.env, 'is_top_drawer_closed')() and
            ...
            action_angles = [0., 0., 0.]
            action_gripper = [0.0]
        elif not env_attr(self.env, 'is_top_drawer_closed')():
